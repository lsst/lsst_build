...
class Git:
    ...
    def sync_checkout(self, *args, **kwargs):
        return asyncio.run(self('checkout', *args, **kwargs))

    def sync_rev_parse(self, *args, **kwargs):
        return asyncio.run(self('rev-parse', *args, **kwargs))

    def sync_reset(self, *args, **kwargs):
        return asyncio.run(self('reset', *args, **kwargs))

    def sync_clean(self, *args, **kwargs):
        return asyncio.run(self('clean', *args, **kwargs))

    def sync_fetch(self, *args, **kwargs):
        return asyncio.run(self('fetch', *args, **kwargs))

    def sync_pull(self, *args, **kwargs):
        return asyncio.run(self('pull', *args, **kwargs))

    def sync_commit(self, *args, **kwargs):
        return asyncio.run(self('commit', *args, **kwargs))

    def sync_add(self, *args, **kwargs):
        return asyncio.run(self('add', *args, **kwargs))

    def sync_tag(self, *args, **kwargs):
        return asyncio.run(self('tag', *args, **kwargs))

    def sync_describe(self, *args, **kwargs):
        return asyncio.run(self('describe', *args, **kwargs))

    def sync_lfs(self, *args, **kwargs):
        return asyncio.run(self('lfs', *args, **kwargs))
